// Trending page with sticky header support
        ...
        <section className="pt-16 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <TrendingUp className="w-12 h-12 text-amber-600 dark:text-amber-500" />
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto transition-colors duration-300">
              Discover what's hot this week. The most popular movies and TV shows trending worldwide.
            </p>
            ...
            {totalResults > 0 && (
              <div className="mt-6 text-gray-500 dark:text-gray-400 transition-colors duration-300">
                <p className="text-sm">
                  {isSearchMode ? 'Found' : 'Showing'} {totalResults.toLocaleString()} {isSearchMode ? 'results' : 'trending items'}
